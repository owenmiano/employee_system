    ...
    public static void start() {
        try {
            ...
            PathHandler pathHandler = Handlers.path()
                    .addPrefixPath(BASE_REST_API_URL + "/company", Routes.Company())
                    .addPrefixPath(BASE_REST_API_URL + "/department", Routes.Department())
                    .addPrefixPath(BASE_REST_API_URL + "/period", Routes.Period())
                    .addPrefixPath(BASE_REST_API_URL + "/earning", Routes.Earning());
